 ...
 */
@ConfigurationProperties("bremersee.email-change")
@Component
@Getter
@Setter
@ToString
...
public class EmailChangeProperties {
  ...
  private String link = "http://localhost:8080/authman/email-change?hash={requestHash}";

  private String sender = "no-reply@bremersee.org";

  private String subjectCode = "email.change.request.subject";
