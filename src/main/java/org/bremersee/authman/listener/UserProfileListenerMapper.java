 ...
 */
public interface UserProfileListenerMapper {

  UserProfileRegistrationRequestEvent mapToRegistrationRequestEvent(
      @NotNull UserProfileCreateRequestDto request,
      @NotNull Date expirationDate);

  UserProfileCreationEvent mapToCreationEvent(
      @NotNull UserProfileDto userProfile,
      String password,
      @NotNull Collection<String> roles);

  UserProfileChangeEvent mapToChangeEvent(
      @NotNull UserProfileDto userProfile);
