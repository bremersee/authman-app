...
public interface OAuth2AccessTokenRepository extends MongoRepository<OAuth2AccessToken, String> {
  ...
  Optional<OAuth2AccessToken> findByValue(String tokenValue);

  List<OAuth2AccessToken> findFirstByUserNameAndClientIdAndScopesOrderByExpirationAsc(
      String userName, String clientId, String scopes);

  List<OAuth2AccessToken> findFirstByUserNameIsNullAndClientIdAndScopesOrderByExpirationAsc(
